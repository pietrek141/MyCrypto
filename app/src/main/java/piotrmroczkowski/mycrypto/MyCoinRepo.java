...
import static piotrmroczkowski.mycrypto.Cryptocurrency.myCoinList;
...
/*    public void insertToMyCoin(CryptoDatabaseHelper helper) {
        SQLiteDatabase writableDatabase = dbHelper.getWritableDatabase();
        for (int i = 0; i < myCoinList.size(); i++) {
            String name = myCoinList.get(i).getName();
            insertToMyCoinByName(writableDatabase, name);
        }
    ...
    public void insertToMyCoinByName(String symbol, String price){
        ...
        //coinValues.put("BUY_DATE", buyDate);
